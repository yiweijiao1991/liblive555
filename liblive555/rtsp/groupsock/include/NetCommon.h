...
/* yzhu:  change EAGAIN into MY_EAGAIN, EINTR into MY_EINTR, 
which have already defined in 
C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\include\errno.h */
#define MY_EAGAIN WSAEWOULDBLOCK
