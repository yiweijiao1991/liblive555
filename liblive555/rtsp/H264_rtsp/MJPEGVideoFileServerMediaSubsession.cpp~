...
MJPEGVideoFileServerMediaSubsession*
MJPEGVideoFileServerMediaSubsession::createNew(UsageEnvironment& env,
					       char const* fileName,
					       Boolean reuseFirstSource) {
  return new MJPEGVideoFileServerMediaSubsession(env, fileName, reuseFirstSource);
}

MJPEGVideoFileServerMediaSubsession
::MJPEGVideoFileServerMediaSubsession(UsageEnvironment& env,
...
static void afterPlayingDummy(void* clientData) {
  MJPEGVideoFileServerMediaSubsession* subsess
    = (MJPEGVideoFileServerMediaSubsession*)clientData;
  subsess->afterPlayingDummy1();
}

void MJPEGVideoFileServerMediaSubsession::afterPlayingDummy1() {
...
void MJPEGVideoFileServerMediaSubsession::checkForAuxSDPLine1() {
...
char const* MJPEGVideoFileServerMediaSubsession
...
FramedSource* MJPEGVideoFileServerMediaSubsession
...
RTPSink* MJPEGVideoFileServerMediaSubsession
...
char const*
MJPEGVideoFileServerMediaSubsession::sdpLines() {
...
int MJPEGVideoFileServerMediaSubsession::getEncType()
{
	return 2;
}

int MJPEGVideoFileServerMediaSubsession::getJpegQ( int streamID)
{
